...
build_rpc_trait! {
	...
	pub trait Eth {
		...
		/// Returns logs with timestamp and ether value matching given filter object.
		#[rpc(async, name = "eth_getLogsDetails")]
		fn logs_details(&self, Filter) -> BoxFuture<Vec<LogDetails>, Error>;
